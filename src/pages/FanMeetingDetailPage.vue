<template>
  <div class="w-full min-h-screen bg-white">
    ...
    <div class="px-4 pb-32">
      <!-- Fan Meeting Image -->
      <div
        class="w-full h-64 bg-gradient-to-br from-purple-400 to-pink-500 rounded-lg mb-6 overflow-hidden"
      >
...
const fanMeetingInfo = ref({
  ...
  price: '99,000',
  description:
    '여단오와 함께하는 특별한 시간! 다양한 이벤트와 소통의 시간이 준비되어 있습니다. 팬들과의 만남을 통해 더욱 가까워질 수 있는 소중한 기회입니다.',
})
