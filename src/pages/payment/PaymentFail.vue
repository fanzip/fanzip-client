<template>
  <div class="w-full min-h-screen bg-white text-center flex flex-col items-center">
    ...
    <!-- 아이콘 영역 -->
    <div class="mt-[256px] w-[81px] h-[81px]">
    ...
    <!-- 실패 메시지 -->
    <p class="mt-[60px] text-[20px] text-black font-normal">
      결제 처리 중 문제가 발생했습니다.
    </p>

    <!-- 버튼 영역 -->
    <div class="mt-[329px] px-[20px] w-full max-w-[353px] flex gap-3 justify-center flex-wrap">
      <BaseButton variant="primary" size="md" @click="retryPayment" class="flex-1 min-w-[140px]">
        다시 결제
      </BaseButton>
      <BaseButton variant="cancel" size="md" @click="goToHome" class="flex-1 min-w-[140px]">
        홈으로
      </BaseButton>
    </div>
  </div>
