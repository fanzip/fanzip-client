            ...
            <div class="flex items-center">
              <div class="w-6 h-6 mr-3">
                ...
                >
                  ...
                  <path
                    d="M12 6C8.5 6 6 8.5 6 11.5C6 13.5 7.5 15.5 9.5 16.5L8.5 19.5L11.5 17.5C11.7 17.5 11.8 17.5 12 17.5C15.5 17.5 18 15 18 11.5C18 8.5 15.5 6 12 6Z"
                    fill="#3C1E1E"
                  />
                </svg>
                <svg
