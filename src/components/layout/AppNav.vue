...
<template>
    <nav
      class="fixed bottom-0 left-1/2 -translate-x-1/2 w-[393px] h-[76px] bg-white
             border-t border-l border-r border-[#EFEFEF] rounded-t-[16px] flex items-center justify-center z-50"
    >
